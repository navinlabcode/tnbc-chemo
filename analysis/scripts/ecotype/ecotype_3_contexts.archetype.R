...
dict_pat_to_response <- dict_pat_to_response[, c('patient', 'archetypes')]
...
dict_sample$archetypes <- dict_sample$archetypes
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Investigate archetypes (ARC1:ARC4)            ~~~~    
#~~~~~~~~~~~~~~~~~~~~~~~~~~~
#------ separate samples to each context ------

dict_combo_sample_names <- dict_sample %>% dplyr::mutate(combo_id = paste0(archetypes)) %>%
