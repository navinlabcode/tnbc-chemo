#--------------------------
# Prepare sigle patient seurat3 object (mostly use RNA assya)
#--------------------------
...
if (! file.exists(f_sr_out)){
  ...
  sr3 <- ScaleData(sr3, assay = assay_use, 
                  ...
                  vars.to.regress = vars.to.regress.str)#, vars.to.regress = 'nCount_RNA')
  #------ Dimention Reduction ------
  ...
  # if (ncol(sr3) > 1e3) {
    # sr3 <- RunTSNE(
    #   sr3, tsne.method = 'FIt-SNE',
    #   reduction = "pca", assay = assay_use,
    #   dims = 1:n_pc_nn,
    #   fast_tsne_path = '/volumes/USR1/yyan/apps/FIt-SNE-1.2.1/bin/fast_tsne',
    #   perplexity = 35, check_duplicates=F)
    # sr3 <- RunTSNE(
    #     sr3, 
    #     reduction = "pca", assay = assay_use,
    #     dims = 1:n_pc_nn,
    #     # fast_tsne_path = '/volumes/USR1/yyan/apps/FIt-SNE-1.1.0/bin/fast_tsne',
    #     perplexity = 35, check_duplicates=F)
  # }
  if (F){
...
#------ Expore PCA and ICA -----
# Done by 'explore_PCA_ICA.R' function

#------ Run DE ------
# to do by 'std.FindAllMarkers.R'
