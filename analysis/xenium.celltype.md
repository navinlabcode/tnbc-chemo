...
We decide to use 10 votes as the threshold, because we find that the cells having <10 votes have drastically smaller probability of prediction, smaller total molecule counts, and smaller total number of detected genes. This pattern is found in different cell types, as illustrated in **panel c and d**. This pattern is also found in multiple samples, as illustrated in **panel e**. 
